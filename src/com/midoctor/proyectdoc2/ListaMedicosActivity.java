	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView tv_content = (TextView) findViewById(R.id.doc_info);
		 if(especialidad.equals("alergologo")){
				...
				tv_content.setText("Es el medico especializado en el diagnostico y tratamiento de las enfermedades  alérgicas, así como alergia a medicamentos y alimentos. Enfermedades que trata: Rinitis alérgica, asma, urticaria. Dermatitis alérgica, alergia a insectos");
		 }
		 else if(especialidad.equals("audiologo")){
				tv_title.setText("Audiológo");
				img.setBackgroundResource(R.drawable.mascota_audiologo);
				tv_content.setText("Es el medico especializado en el tratamiento, diagnostico y rehabilitación de los problemas y discapacidades auditivas. \n Enfermedades que trata:  otitis media, zumbido de oídos, perdida de la audición, vértigo, mareo.");
		 }else if(especialidad.equals("cardiologo")){
				tv_title.setText("Cardiólogo");
				img.setBackgroundResource(R.drawable.mascota_cardio);
				tv_content.setText("El cardiólogo es el especialista medico encargado de atender las enfermedades relacionadas con el corazón y el aparato circulatorio. Enfermedades que trata: hipertensión arterial, insuficiencia cardiaca, pericarditis, endocarditis.");
				...
				tv_content.setText("Es el medico especializado en los padecimiento de la piel, ofrece diagnostico, prevención y tratamiento.\n Enfermedades que trata:  acne, dermatitis, comezón.");
				...
				tv_content.setText("Es el medico especializado en las enfermedades hormonales, del metabolismo y de los problemas alimenticios o de nutrición. Enfermedades que trata: diabetes, menopausia, obesidad.");
				...
				classespecialidades one = new
						classespecialidades("1","Dr. Raúl Barragán Parrao","Gastroenterólogo","998 8980801","raulbapa@hotmail.com",especialidad,"", "",
				...
				tv_content.setText("Es el especializado medico encargado del diagnostico y tratamiento de las enfermedades y trastornos de la sangre. Enfermedades que trata: leucemia, anemia, linfomas, trastornos hemorrágicos.");
				...
				tv_content.setText("Es el profesional especializado en la cirugía del cerebro y la columna vertebral. Enfermedades que trata: neurocisticercosis, tumores descebarles, hernias de disco.");
		 }else if(especialidad.equals("neumologo")){
				tv_title.setText("Neumólogo");
				img.setBackgroundResource(R.drawable.mascota_neumologo);
				tv_content.setText("Es el medico especializado en el estudio de las enfermedades del aparato respiratorio. Enfermedades que trata: bronquitis, enfisema pulmonar, neumonía, fibrosis quística.");
				...
				tv_content.setText("Es el especialista medico encargado del análisis, diagnostico y tratamiento del cáncer. Enfermedades que trata: cáncer de mama, cáncer de pulmón, cáncer de colon.");
				...
				tv_content.setText("Es el medico especializado en la prevención y tratamiento de las afecciones o traumas de huesos y músculos. Enfermedades que trata:  fracturas, artritis, tendosinovitis estenosante, distensión muscular.");
				...
				tv_content.setText("Medico especialista enfocado a las enfermedades de oídos, nariz y garganta. Enfermedades que trata: otitis , rinitis, laringitis , traqueítis, desviación septal, pólipos nasales.");
		 }else if(especialidad.equals("psicologo")){
				tv_title.setText("Psicólogo");
				img.setBackgroundResource(R.drawable.mascota_psicologo);
				tv_content.setText("Es el profesional medico especializado en la salud mental. Enfermedades que trata: anorexia, apatía, demencia, depresión.");
				...
				tv_content.setText("El reumatólogo es el medico especialista encargado del diagnóstico y atención de las enfermedades relacionadas con el aparato locomotor es decir con cualquier malestar del cuerpo. Enfermedades que trata: artritis, osteoporosis, fibromialgia entre otras.");
				...
				tv_content.setText("Es el medico especializado en el estudio de las vías urinarias, ofrece tratamiento, prevención y diagnostico a pacientes de todas las edades. Enfermedades que trata: infección de vías urinarias y enfermedades de transmisión sexual.");
		 }
