...
public class DetalleLaboratorioActivity extends Activity {
	     ...
	     /*  textdireccion = (TextView)findViewById(R.id.direccion);
		  ...
		  else
		  {
			  ...
			  hImageViewPic.setImageDrawable( getResources().getDrawable(R.drawable.risa)); 
				 ...
				 if(nombre.equals("Laboratorios Torre"))
				{
					//header.setImageDrawable( getResources().getDrawable(R.drawable.header_peidatra));
					imgs.add(R.drawable.tlabs_1);
					imgs.add(R.drawable.tlabs_2);
					imgs.add(R.drawable.tlabs_3);
					hImageViewPic.setImageDrawable( getResources().getDrawable(R.drawable.tlabs_1));
					iButton.setOnClickListener(iButtonChangeImageListener);
				    gButton.setOnClickListener(gButtonChangeImageListener);
				}
	...
	View.OnClickListener openWebsite = new OnClickListener() {
	 ...
	 public boolean onKeyUp(int keyCode, KeyEvent msg) {
	      ...
	      case(KeyEvent.KEYCODE_BACK):
			    	 ...
			    	 Intent a1_intent = new Intent(this, LaboratoriosActivity.class);
